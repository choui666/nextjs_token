...
export default async function sendGift(req, resp) {
  ...
  const url = `https://zim-api.zego.im/?Action=SendRoomMessage&AppId=${
    app_id * 1
  }&Timestamp=${serverTimeStamp}&Signature=${signature}&SignatureVersion=2.0&SignatureNonce=${signatureNonce}`;
